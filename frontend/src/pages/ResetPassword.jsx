...
const ResetPassword = () => {
  ...
  // Fill input and move to the next one 
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-blue-300'>
      ...
      {/* Enter email */}
      {!isEmailSent && (
        <form onSubmit={onSubmitEmail} className='bg-[#f0f1f4] p-8 rounded-lg shadow-lg w-96 text-sm'>
          <h1 className='text-blue-700 text-2xl font-semibold text-center mb-4'>Reset Your Password</h1>
      ...
      {!isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitOTP} className='bg-white p-8 rounded-lg shadow-lg w-96 text-sm'>
          <h1 className='text-blue-700 text-2xl font-semibold text-center mb-4'>Reset Password OTP</h1>
      ...
      {isOtpSubmitted && isEmailSent && (
        <form onSubmit={onSubmitNewPassword} className='bg-white p-8 rounded-lg shadow-lg w-96 text-sm'>
          <h1 className='text-blue-700 text-2xl font-semibold text-center mb-4'>New Password</h1>
          <p className='text-center mb-6 text-indigo-300'>Enter your new password below</p>
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#f0f1f4]'>
