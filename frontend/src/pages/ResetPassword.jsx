...
const ResetPassword = () => {
  ...
  const [isOtpSubmited ,setIsOtpSubmited] = useState(false)
   ...
   const inputRefs = React.useRef([]);
    ...
    //fill input to pass at the next one 
  ...
  return (
    <div className='flex items-center justify-center min-h-screen  bg-gradient-to-b from-blue-200 to-blue-900'>
        ...
        <h1 className='text-white text-2xl font-semibold text-center mb-4'>Réinitialiser votre mot de passe</h1>
