...
const EmailVerify = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-blue-300'>
      <form onSubmit={onSubmitHandler} className='bg-[#f0f1f4] p-8 rounded-lg shadow-lg w-96 text-sm'>
        <h1 className='text-blue-700 text-2xl font-semibold text-center mb-4'>Verify Your Email Address</h1>
